...
def first_existing_path(candidates: List[Path]) -> Path:
    """
    Retorna o primeiro caminho existente. Se nenhum existir, retorna o primeiro
    candidato para que a mensagem de erro mostre o caminho esperado.
    """
...
DEFAULT_MODEL_PATH = first_existing_path(
    [
        ...
        PROJECT_ROOT / "reports" / "model_v3_mel_sensitive_final" / "cnn_ham10000_v3.keras",
        PROJECT_ROOT / "reports" / "model_v3" / "cnn_ham10000_v3.keras",
        PROJECT_ROOT / "reports" / "model_v2_mel_sensitive_final" / "cnn_ham10000_v2.keras",
    ]
)

DEFAULT_POLICY_PATH = first_existing_path(
    [
        PROJECT_ROOT / "reports" / "model_v3_mel_focal" / "decision_policy_v3.json",
        PROJECT_ROOT / "reports" / "model_v3_mel_sensitive_final" / "decision_policy_v3.json",
        PROJECT_ROOT / "reports" / "model_v3" / "decision_policy_v3.json",
        PROJECT_ROOT / "reports" / "model_v2_mel_sensitive_final" / "decision_policy_v2.json",
    ]
)
...
# ============================================================
# Custom loss do modelo v3
# ============================================================

class SparseCategoricalFocalLoss(keras.losses.Loss):
    """
    Focal loss multiclasse usada no treino do modelo v3.

    O modelo v3 foi salvo com esta loss customizada. Por isso, ela precisa
    estar disponível no app para que o arquivo .keras seja carregado
    corretamente pelo Keras.
    """
...
def preprocess_image(image: Image.Image) -> np.ndarray:
    ...
    O modelo v3 foi treinado recebendo pixels 0-255 e o preprocess_input da
...
st.markdown(
    """
Este protótipo utiliza o modelo **v3 melanoma-sensitive**, desenvolvido na Sprint 5,
